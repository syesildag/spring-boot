...
(function (GenericFactory) {
    ...
    var Base = (function () {
        function Base() {
            this.classMap = {};
            for (var _i = 0, _a = this.getClassList(); _i < _a.length; _i++) {
                var clazz = _a[_i];
                var key = new clazz().supply();
                this.classMap[key.toString()] = clazz;
            }
        }
        Base.prototype.create = function (key) {
            var args = [];
            for (var _i = 1; _i < arguments.length; _i++) {
                args[_i - 1] = arguments[_i];
            }
            var clazz = this.classMap[key.toString()];
            return new clazz(args);
        };
        Base.prototype.getClassList = function () {
            return [];
        };
        return Base;
    }());
...
(function (JReactComponents) {
    ...
    var List = (function (_super) {
        ...
        List.prototype.getFromScrollParent = function (key) {
            var scrollParent = this.scrollParent;
            return scrollParent === window ?
...
(function (JReactComponents) {
    ...
    var LongPress = (function (_super) {
        ...
        LongPress.prototype.onMouseDown = function (e) {
            var _this = this;
            if (e.button === 0)
                LongPress.timeout = window.setTimeout(function () {
...
(function (RslPromise) {
    ...
    (function (Type) {
        ...
        Type[Type["JQUERY"] = 1] = "JQUERY";
    })(Type || (Type = {}));
    ;
    var NativePromise = (function () {
        function NativePromise() {
        }
        NativePromise.prototype.supply = function () {
            return Type.NATIVE;
        };
        NativePromise.prototype.create = function (func, context) {
            return new Promise(func.bind(context));
        };
        NativePromise.prototype.resolve = function (value) {
            return Promise.resolve(value);
        };
        NativePromise.prototype.reject = function (error) {
            return Promise.reject(error);
        };
        NativePromise.prototype.all = function (promises) {
    ...
    var JQueryPromise = (function () {
        ...
        JQueryPromise.prototype.supply = function () {
            return Type.JQUERY;
        };
        JQueryPromise.prototype.create = function (func, context) {
            var deferred = jQuery.Deferred();
            func.call(context, deferred.resolve, deferred.reject);
            return deferred.promise();
        };
        JQueryPromise.prototype.resolve = function (value) {
            var deferred = jQuery.Deferred();
            deferred.resolve(value);
            return deferred.promise();
        };
        JQueryPromise.prototype.reject = function (error) {
            var deferred = jQuery.Deferred();
            deferred.reject(error);
            return deferred.promise();
        };
        JQueryPromise.prototype.all = function (promises) {
            return new Wrapper(jQuery.when.apply(jQuery, promises));
        };
        return JQueryPromise;
    }());
    var Wrapper = (function () {
        function Wrapper(thenable) {
            this.thenable = thenable;
        }
        Wrapper.prototype.then = function (onFulfilled, onRejected) {
            function onFulfilledWrapper() {
                var args = [];
            ...
            return this.thenable.then(onFulfilledWrapper, onRejected);
        };
        return Wrapper;
    }());
    var PromiseFactory = (function (_super) {
        __extends(PromiseFactory, _super);
        function PromiseFactory() {
            _super.apply(this, arguments);
        }
        PromiseFactory.prototype.getClassList = function () {
    ...
    RslPromise.isNative = isNative;
    var promise;
    var promiseFactory = new PromiseFactory();
    function forceJQuery(forceJQuery) {
        promise = !forceJQuery && isNative() ? promiseFactory.create(Type.NATIVE) : promiseFactory.create(Type.JQUERY);
    }
    RslPromise.forceJQuery = forceJQuery;
    forceJQuery(false);
    function create(func, context) {
        return promise.create(func, context);
    }
    RslPromise.create = create;
    function resolve(value) {
        return promise.resolve(value);
    }
    RslPromise.resolve = resolve;
    function reject(error) {
        return promise.reject(error);
    }
    RslPromise.reject = reject;
    function all(promises) {
        return promise.all(promises);
    }
    RslPromise.all = all;
})(RslPromise || (RslPromise = {}));
/// <reference path="./jreact.ts"/>
/// <reference path="../typings/tsd.d.ts"/>
var JReactComponents;
(function (JReactComponents) {
