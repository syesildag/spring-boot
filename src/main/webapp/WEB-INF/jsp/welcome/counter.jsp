   ...
   <script type="text/javascript">
       $(document).ready(function() {
           ...
           for (var i = 0, n = elements.length; i < n; i++)
             ReactDOM.render(React.createElement(Serkan.Counter, {initialClickCount: parseInt(elements[i].getAttribute("initialClickCount"))}), elements[i]);
       });
   </script>
</head>

<body>
   <div class="message" initialClickCount="1" align="center"></div>
   <div class="message" initialClickCount="5" align="center"></div>
</body>
